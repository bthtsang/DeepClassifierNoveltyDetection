...
from survey_rnngmm_classifier import preprocess
...
def main(args=None):
  ...
  print ("number of samples", len(split), len(split_new))
...
#  gamma_new_K = K.variable(gamma_new)
  ...
  print ("energy sizes", energy_train.shape, energy_valid.shape, energy_new.shape)
  ...
  ### Writing results
  txtfile.write("===== Classifier Accuracies =====\n")
  txtfile.write(f"Neural Network Classifier: {nn_acc}\n")
  txtfile.write("==========================\n")
